...
public:
	...
	void DrawCastle(bool=true,bool=true,bool=true,bool=true) const;	    // draws the castle with the towers and 4 regions
	void Drawpaved(int A=30,int B=30,int C=30,int D=30);
	...
	MenuItem GetCurrentClick(Point&) const;
